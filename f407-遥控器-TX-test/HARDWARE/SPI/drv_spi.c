...
//	//SCK MOSI MISO 配置为复用
//	GPIO_InitStructure.GPIO_Pin          = GPIO_PinSource5|GPIO_PinSource6|GPIO_PinSource7;//PA5~7复用功能输出	
//	GPIO_InitStructure.GPIO_Speed        = GPIO_Speed_50MHz;
//	GPIO_InitStructure.GPIO_Mode         = GPIO_Mode_AF;
//	GPIO_InitStructure.GPIO_OType        = GPIO_OType_PP;
//	GPIO_InitStructure.GPIO_PuPd         = GPIO_PuPd_UP;
//	GPIO_Init( SPI_CLK_GPIO_PORT, &GPIO_InitStructure );		//初始化SCK
	

	GPIO_PinAFConfig(SPI_CLK_GPIO_PORT,GPIO_PinSource13,GPIO_AF_SPI2); //PB3复用为 SPI1
	
	GPIO_PinAFConfig(SPI_MOSI_GPIO_PORT,GPIO_PinSource14,GPIO_AF_SPI2); //PB4复用为 SPI1

	GPIO_PinAFConfig(SPI_MISO_GPIO_PORT,GPIO_PinSource15,GPIO_AF_SPI2); //PB5复用为 SPI1
...
//	GPIO_InitStructure.GPIO_OType        = GPIO_OType_PP;
//	GPIO_InitStructure.GPIO_PuPd         = GPIO_PuPd_UP;
//	GPIO_Init( SPI_NSS_GPIO_PORT, &GPIO_InitStructure );		//初始化NSS
