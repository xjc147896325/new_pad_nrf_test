/**
  ...
  * @brief   drvice for i2c
						 ...
						 I2C_WriteCmd(unsigned char I2C_Command) I2C写命令
						 I2C_WriteDat(unsigned char I2C_Data) I2C写命令
...
void I2C_WriteCmd(unsigned char I2C_Command)//写命令
{
	I2C_WriteByte(0x00, I2C_Command);
}

void I2C_WriteDat(unsigned char I2C_Data)//写数据
{
